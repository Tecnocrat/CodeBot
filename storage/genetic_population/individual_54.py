...
# Mutation applied: 0.5237201192678755
...
# Mutation applied: -0.15202679014226256
...
# Mutation applied: -0.21795457412283667
...
def generate_metadata(base_dir, output_file):
    """
# Mutation applied: 1.2287042370412917
...
# Mutation applied: 1.1491404888853147
    metadata = parse_codebase(base_dir, output_file)
    logging.info(f"Metadata saved to {output_file}")

# Mutation applied: -0.32297877001570835
def handle_errors(func):
    """
# Mutation applied: 0.9553885255118785
...
def generate_metadata_command():
    """
# Mutation applied: 0.09150600507039836
...
# Mutation applied: 0.9578342606963103
...
# Mutation applied: -0.24104918267313463
    initialize_codebot()  # Initialize AI engine and logging
# Mutation applied: 0.01987354425634864
