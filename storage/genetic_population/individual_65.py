...
# Mutation applied: 0.6292227558693223
...
# Mutation applied: 1.1472716089321133
...
# Mutation applied: 0.39019111451742566
...
# Mutation applied: 0.34337078453293274
def handle_errors(func):
    """
    Decorator to handle errors and log them.

    Args:
# Mutation applied: 0.47507956901556936
        func (callable): The function to wrap.
# Mutation applied: 1.1536933935461773

    Returns:
# Mutation applied: -0.07674858287640003
...
# Mutation applied: 1.0386982306061197
    """
...
# Mutation applied: 0.8016682747979341
...
# Mutation applied: -0.15041351573083284
        bounds = (
...
# Mutation applied: 0.46767126158677175

        return (
# Mutation applied: 0.9830337252470674
            f"Population of size {population_size} created in {output_dir}.\n"
            f"Dimensions: {dimensions}, Bounds: {bounds}"
        )
# Mutation applied: 1.0847741438684844
    except Exception as e:
# Mutation applied: 1.0498953747638642
        logging.error(f"Error initializing population: {e}")
        return f"An error occurred: {e}"

# ------------------
# Mutation applied: 1.0648158975469426
# EXCHANGE LAYER
# ------------------
...
# Mutation applied: 0.13259066410640694
        return (
            "Available commands:\n"
...
# MAIN EXECUTION
# ------------------
# Mutation applied: 0.5165041454715124
