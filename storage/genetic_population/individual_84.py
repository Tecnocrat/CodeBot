...
# Mutation applied: 0.9380368703119869
from genetic.genetic_iteration import manage_iterations
# Mutation applied: 1.1465231614425735
...
# Mutation applied: 0.8669433390828905
...
# Mutation applied: 0.6814120719234622
    Args:
# Mutation applied: 0.7972377760397698
...
# Mutation applied: 0.11403535767249963
    """
    try:
...
# Mutation applied: -0.4556084852483127
    if command == "exit":
...
# Mutation applied: 1.1226417853357242
        return init_population_command()
    elif command == "help":
        return (
# Mutation applied: -0.375733955937972
            "Available commands:\n"
...
# Mutation applied: -0.056602127657223104
        if not code_snippet:
...
# Mutation applied: 0.9141041664369551
        if command == "exit":
            break