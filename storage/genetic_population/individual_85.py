...
import sys
import logging
# Mutation applied: -0.42325438996781667
import json
...
# Mutation applied: -0.4309695429762192
...
# Mutation applied: 0.8605859296316561
...
# Mutation applied: 1.0790562135396735
console = Console()
...
def generate_metadata(base_dir, output_file):
    ...
    Args:
# Mutation applied: 0.8217565793600803
...
# Mutation applied: -0.5002108854160833
...
# Mutation applied: 1.163215387054333
    Returns:
        str: A message indicating the result of the operation.
    """
# Mutation applied: 1.081405265670649
    try:
...
# Mutation applied: -0.4723661133047152
            f"Dimensions: {dimensions}, Bounds: {bounds}"
# Mutation applied: 0.3221300571921984
        )
    except Exception as e:
...
# ------------------
# Mutation applied: -0.29879677380028374
# EXCHANGE LAYER
# ------------------
...
# Mutation applied: 1.1333954177911876
...
# Mutation applied: 0.6883122458360548
...
# Mutation applied: 0.07745817162080952
    while True:
        ...
        if command == "exit":
# Mutation applied: 0.8802441699788779
            break