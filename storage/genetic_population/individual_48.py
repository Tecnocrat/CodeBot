...
# Mutation applied: 1.088339671639166
logging.basicConfig(
    level=logging.DEBUG,
    format="%(asctime)s - %(levelname)s - %(message)s",
# Mutation applied: -0.2966128192472894
    handlers=[
        logging.FileHandler(LOG_FILE, mode="a"),  # Append mode to ensure logs are written
        logging.StreamHandler(sys.stdout)
    ]
# Mutation applied: 1.2047303856413152
)
...
# Mutation applied: 0.3156949409026745
...
def generate_metadata(base_dir, output_file):
    ...
    Args:
# Mutation applied: 1.057435012251202
...
# Mutation applied: -0.4011090467269907
        try:
            return func(*args, **kwargs)
        except Exception as e:
            logging.error(f"Error in {func.__name__}: {e}")
            return f"An error occurred: {e}"
# Mutation applied: 1.1086294117855364
    return wrapper
...
# Mutation applied: 0.3674506819786032
    """
# Mutation applied: 0.5790325981648625
...
# Mutation applied: 0.29618989254072114
...
# Mutation applied: 0.6776526459150648
...
# Mutation applied: 0.43943330811344655
...
# Mutation applied: -0.22314448845743676
    elif command == "help":
        return (
            "Available commands:\n"
...
# ------------------
# MAIN EXECUTION
# Mutation applied: 0.7954086853098851
# ------------------
