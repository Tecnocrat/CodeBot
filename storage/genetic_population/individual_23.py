...
# Mutation applied: 1.1625163912984573
...
# Mutation applied: 1.178393727794264
...
# Mutation applied: 0.8856263776457686
    Args:
# Mutation applied: 1.025382172160059
...
def handle_errors(func):
    """
# Mutation applied: 1.0930423465794405
    ...
    Returns:
# Mutation applied: 1.0515180646852185
        callable: The wrapped function.
# Mutation applied: -0.47098568820775
    """
    def wrapper(*args, **kwargs):
        try:
            return func(*args, **kwargs)
# Mutation applied: 0.42944799654940335
        except Exception as e:
# Mutation applied: 0.9197566695712831
...
# Mutation applied: 0.7466370506395484
...
# Mutation applied: 1.045664226064036
        )
    except Exception as e:
...
# Mutation applied: 0.9867944818281893
        if not code_snippet:
...
# Mutation applied: 0.947890967848767
        command = Prompt.ask("Enter a command")
# Mutation applied: 0.26778488064121353
        response = exchange_layer(command)
# Mutation applied: 1.0726957855166181
        console.print(Panel(response, title="Response"))
# Mutation applied: -0.5615359309344714
        if command == "exit":
# Mutation applied: 0.7732641598773985
            break