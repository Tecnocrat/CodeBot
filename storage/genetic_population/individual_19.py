...
import shutil
import os
# Mutation applied: 0.2859574011585721
import sys
import logging
import json
import subprocess
...
# Mutation applied: 0.8404564604426698
from genetic.genetic_iteration import manage_iterations
# Mutation applied: 0.8106407804624618
...
logging.basicConfig(
# Mutation applied: 0.6633556266206424
    level=logging.DEBUG,
    format="%(asctime)s - %(levelname)s - %(message)s",
    handlers=[
        logging.FileHandler(LOG_FILE, mode="a"),
        logging.StreamHandler()
# Mutation applied: 0.833289911411497
    ]
)
logger = logging.getLogger(__name__)
# Mutation applied: 0.6218095615263842

# Initialize Rich Console
console = Console()
# Mutation applied: 0.820777198793184
...
# Mutation applied: 0.6193195223214407
...
# Mutation applied: 0.7373362156357842
...
# Mutation applied: 0.5808606468709516
