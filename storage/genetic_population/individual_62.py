...
# Mutation applied: 0.7265612420246186
...
# Mutation applied: 0.690756186310407
...
# Mutation applied: 0.5432148487877841
    Returns:
...
# Mutation applied: -0.2855990772389845

    Returns:
        str: A message indicating the result of the operation.
    """
    try:
# Mutation applied: 1.05001075297103
...
# Mutation applied: 0.9825380274648018
...
# Mutation applied: 0.29983948211476136
        )
    except Exception as e:
...
# Mutation applied: 1.1633862316177406
    """
    logging.debug(f"Received command: {command}")
    command = sanitize_input(command, context="general")

# Mutation applied: 1.0916947178317082
    if command == "exit":
...
# Mutation applied: 0.8355751692587213
        return (
            "Available commands:\n"
# Mutation applied: 1.1269758557392329
...
# Mutation applied: 1.074928815674099
        logging.warning(f"Unknown command: {command}")
        return f"Unknown command: {command}"
# Mutation applied: -0.36747968540543297
...
if __name__ == "__main__":
    ...
    while True:
# Mutation applied: -0.13833965440611418
