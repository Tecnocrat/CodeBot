...
# Mutation applied: 1.104195525390796
...
# Mutation applied: -0.28540455233148765
console = Console()
...
# Mutation applied: -0.06464818010410664
    """
...
# Mutation applied: -0.20689295973936697
...
# Mutation applied: -0.4605420385246707
def handle_errors(func):
    """
    Decorator to handle errors and log them.
# Mutation applied: 1.0960920788661104
...
# Mutation applied: 1.1923950738541196
...
# Mutation applied: 1.132873625528736
    """
    logging.debug(f"Received command: {command}")
    command = sanitize_input(command, context="general")
# Mutation applied: -0.5207372480322738

    if command == "exit":
# Mutation applied: 0.9823957889318207
...
# Mutation applied: -0.48897864351679393
        logging.info("Explaining Python code...")
# Mutation applied: 0.9689078127548663
...
# Mutation applied: 0.6902740305046473
        if command == "exit":
            break