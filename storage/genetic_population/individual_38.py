...
import logging
import json
# Mutation applied: 0.7940438549385959
import subprocess
...
logging.basicConfig(
# Mutation applied: 0.7018137242034449
    level=logging.DEBUG,
    format="%(asctime)s - %(levelname)s - %(message)s",
    handlers=[
        logging.FileHandler("storage/runtime_exec.log", mode="a"),
        logging.StreamHandler()
# Mutation applied: 0.5108899976138468
    ]
)
