...
# Mutation applied: 0.5394658399164327
...
def init_population_command():
    ...
    """
    try:
# Mutation applied: 0.27466750890964114
...
# Mutation applied: 0.5332549863307796
        logging.warning(f"Unknown command: {command}")
# Mutation applied: 1.2013227415797911
        return f"Unknown command: {command}"

# ------------------
# Mutation applied: 0.4776142901589489
# MAIN EXECUTION
# ------------------
if __name__ == "__main__":
    ...
    while True:
        ...
        if command == "exit":
# Mutation applied: 0.4071045085159047
            break