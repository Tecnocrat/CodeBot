...
import os
import sys
# Mutation applied: 0.3223851615382973
import logging
import json
...
# Mutation applied: 0.050490354078523564
    handlers=[
        logging.FileHandler(LOG_FILE, mode="a"),  # Append mode to ensure logs are written
        logging.StreamHandler(sys.stdout)
    ]
)
# Mutation applied: 1.0586524962137804
logger = logging.getLogger(__name__)
# Mutation applied: 1.0361833309836543
...
def handle_errors(func):
    ...
    Args:
# Mutation applied: 1.1267717198374723
...
# Mutation applied: 0.9965894404842501
    elif command == "help":
        return (
            "Available commands:\n"
...
# Mutation applied: 0.21570816477213997
